...
export declare namespace StatusClasses {
    /**
     ...
     */
    type Informational = StatusCodes.CONTINUE | StatusCodes.PROCESSING | StatusCodes.SWITCHING_PROTOCOLS;
    /**
     ...
     */
    type Successful = StatusCodes.ACCEPTED | StatusCodes.CREATED | StatusCodes.MULTI_STATUS | StatusCodes.NO_CONTENT | StatusCodes.NON_AUTHORITATIVE_INFORMATION | StatusCodes.OK | StatusCodes.PARTIAL_CONTENT | StatusCodes.RESET_CONTENT;
    /**
     ...
     */
    type Redirection = StatusCodes.MOVED_PERMANENTLY | StatusCodes.MOVED_TEMPORARILY | StatusCodes.MULTIPLE_CHOICES | StatusCodes.NOT_MODIFIED | StatusCodes.PERMANENT_REDIRECT | StatusCodes.SEE_OTHER | StatusCodes.TEMPORARY_REDIRECT | StatusCodes.USE_PROXY;
    /**
     ...
     */
    type ServerError = StatusCodes.BAD_GATEWAY | StatusCodes.GATEWAY_TIMEOUT | StatusCodes.HTTP_VERSION_NOT_SUPPORTED | StatusCodes.INSUFFICIENT_STORAGE | StatusCodes.INTERNAL_SERVER_ERROR | StatusCodes.NETWORK_AUTHENTICATION_REQUIRED | StatusCodes.NOT_IMPLEMENTED | StatusCodes.SERVICE_UNAVAILABLE;
}
